...
/**
 * Servlet implementation class increaseHitsServlet
 */
public class IncreaseHitsServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		articleBiz.increaseHits(articleId);
