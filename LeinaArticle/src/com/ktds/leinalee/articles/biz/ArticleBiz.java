...
import com.ktds.leinalee.articles.dao.ArticleDAO;
import com.ktds.leinalee.articles.vo.ArticleListVO;
...
public class ArticleBiz {
	...
	public ArticleListVO getArticleList(ArticleSearchVO searchVO) {
		...
		List<ArticleVO> articles = articleDAO.getAllArticlesOne(searchVO);
	...
	public ArticleVO showDetail(int articleId) {
		...
		article.setFileList(fileDAO.getFileListByArticle(articleId));
